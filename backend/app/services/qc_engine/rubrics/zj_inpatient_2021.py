...
# ─── 15. 知情同意书（10 分）— 设计结论：永久归人工检查 ───────────
# （2026-09-16 评估定稿，与门急诊侧同项同口径，后续审计勿再报"空规则"）：
# 知情同意书是纸质签署的独立表单，"签没签"这一事实系统拿不到，任何文本
# 判据都是猜测必产误报。若未来上线电子签署功能，再按签署记录实装。
_INFORMED_CONSENT = RubricItem(
    name="知情同意书",
    max_points=10,
    description="授权委托书/手术麻醉输血知情同意/病情沟通谈话（纸质签署，需人工检查）",
    deduction_rules=(),
)
