...
# 第 10 项"知情同意书 5 分"——设计结论：**本项无法客观机判，永久归人工检查**
# （2026-09-16 评估定稿，后续审计勿再报"空规则"）。两层不可判：
#   ① 前提不可判——"是否发生了需书面同意的医疗活动"要理解处理意见里的
#      操作语义（清创/穿刺/内镜…），关键词表边界模糊必产误报；
#   ② 事实不可判——门诊知情同意书是**纸质签署**，签没签这个事实系统永远
#      拿不到，任何文本判据都是猜测。
# 空规则 = 满分不扣，等价于"本项交人工"——与住院侧同项、会诊/医嘱等
# 审计层条款同一口径。若未来上线电子知情同意签署功能，再按签署记录实装。
_INFORMED_CONSENT = RubricItem(
    name="知情同意书",
    max_points=5,
    description="需取得患者书面同意方可进行的医疗活动须签署知情同意书（纸质签署，需人工检查）",
    deduction_rules=(),
)
